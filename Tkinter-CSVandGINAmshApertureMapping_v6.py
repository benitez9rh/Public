...
rangeM_Entry = Entry(VARMODEL_frame, width = 10, state=NORMAL); rangeM_Entry.insert(-1, "12")
rangem_Entry = Entry(VARMODEL_frame, width = 10, state=NORMAL); rangem_Entry.insert(-1, "8")
angle_Entry = Entry(VARMODEL_frame, width = 10, state=NORMAL); angle_Entry.insert(-1, "135")
